...
# Dependencies health
curl "https://your-deployment-url.com/api/health/deps"
```

### User Registration
```bash
# Register/Login
curl -X POST "https://your-deployment-url.com/api/user/login" \
...
curl -X POST "https://your-deployment-url.com/api/game/session/start" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json"

# Get next image
curl -X POST "https://your-deployment-url.com/api/game/next" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Submit answer (records on blockchain)
curl -X POST "https://your-deployment-url.com/api/game/ans" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{"hash": "IMAGE_HASH", "guess": "ai"}'

# End session (records on blockchain)
curl -X POST "https://your-deployment-url.com/api/game/session/end" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{"completed": true}'
```
...
curl "https://your-deployment-url.com/api/leaderboard/alltime?limit=50&offset=0"

# Gate users leaderboard
curl "https://your-deployment-url.com/api/leaderboard/gateUsers?limit=50&type=all"
```
...
### Leaderboard
```bash
curl "https://your-deployment-url.com/api/leaderboard/alltime?limit=10"
```
...
**Blockchain Integration: 3 Contracts on 0G Galileo Testnet**  
**Version:** 1.0
